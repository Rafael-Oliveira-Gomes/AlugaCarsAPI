...
namespace AlugaCars.Application.Service
{
    public class UsuarioService
    {
        ...
        public UsuarioService(UsuarioRepository userRepository, IConfiguration configuration, SignInManager<Usuario> signInManager, UserManager<Usuario> userManager, IHttpContextAccessor httpContextAccessor)
        {
        ...
        {
            Usuario user = await _userRepository.ConsultarUsuarioPorID(userId);
        ...
        {
            Usuario findUser = await _userRepository.GetUser(user.Id);
            if (findUser == null)
        ...
        {
            Usuario findUser = await _userRepository.GetUser(userId);
            if (findUser == null)
                throw new ArgumentException("Usuário não encontrado");
        ...
        public async Task<bool> SignUp(CreateUsuarioDto signUpDTO)
        {
        ...
        public async Task<Usuario> GetCurrentUser()
        {
            ...
            Usuario user = await _userRepository.GetUser(userId);
